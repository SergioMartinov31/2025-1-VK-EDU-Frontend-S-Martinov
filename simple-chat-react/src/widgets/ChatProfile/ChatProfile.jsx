...
export const ChatPriofile = ({selectChatAPI, showProfile, setShowProfile}) => {
        ...
        <div className='Chat-Profile__header'>
          ...
          {activeChatData && (
              <div className='Chat-Profile__info'>
                  <img className='Chat-Profile__avatar'  src={`${config.API_URL}${activeChatData.avatar}`} alt={activeChatData.name} width="160" height="160"/>
